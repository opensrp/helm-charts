...
#OAuth Profile {{ $index }}
oauth.default.client.id={{ .client_id }}
oauth.default.secret={{ .secret }}
oauth.default.grant.types={{ .grant_types | join "," }}
oauth.default.scope={{ .scope | join "," }}
oauth.default.token.validity={{ .token_validity }}
...
# Metrics config
metrics.additional_ip_allowed={{ include "opensrp-server-web.metricsAdditionalIpAllowed" . }}
metrics.tags={{ .Values.metrics.tags }}
