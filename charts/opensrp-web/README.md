...
| `containerEnvironmentVariables.EXPRESS_LOGS_FILE_PATH`                |             | `"/tmp/logs/express-server/{{ .Release.Name }}-{{ .Release.NameSpace }}-errors.log"`                                               |
| `containerEnvironmentVariables.EXPRESS_COMBINED_LOGS_FILE_PATH`       |             | `"/tmp/logs/express-server/{{ .Release.Name }}-{{ .Release.NameSpace }}-combined.log"`                                             |
