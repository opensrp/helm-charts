...
| `containerEnvironmentVariables.EXPRESS_LOGS_FILE_PATH`                |             | `"/var/log/express-server-errors.log"`                                                                                             |
| `containerEnvironmentVariables.EXPRESS_COMBINED_LOGS_FILE_PATH`       |             | `"/var/log/express-server-combined.log"`                                                                                           |
